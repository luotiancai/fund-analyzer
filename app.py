...
with tab_sse:
    ...
    if sse_df is None or sse_df.empty:
        ...
        with st.expander("📜 策略复盘:买入近3月冠军,大盘回撤超5%卖出"):
            ...
            st.caption(
                "口径:C 类全市场(含债基/固收+,实盘只买 C),仅剔除两类——"
                "QDII/海外/黄金等与 A 股脱钩资产(2022-04-25 原始榜首原油 QDII"
                "持有仅 +1.3%,同日国内煤炭 C +10.3%),以及巨额赎回假净值"
                "(迷你债基月涨 5%~7% 的赎回费入账,如 2018 两榜前几名、前海"
                "开源弘泽/弘丰)。榜单结构=市场状态探测器:2018-10-29 前排被"
                "债基/固收+霸榜=熊市信号,顺势买固收+冠军 +1.7%,硬选权益冠军"
                "(银行指数)反亏 -2.5%;2020/2024 前排全是权益=风险偏好在场。"
                "赚钱四次:恐慌急跌日买国内权益冠军 +22.1%/+32.5%/+10.3%,"
                "及 2024-09-30 亢奋日买入靠 10/8 最后一冲 +6.05% 逃顶(10/9 即"
                "触发止损,纯靠 5% 线快跑,不可复制)。亏钱五次:亢奋追入"
                "(2019-02-25 -1.2%)、垂直拉升后追入(2020-07-16 -2.7%)、风格"
                "切换(2018-02-09 -4.5%)、下跌中段(2020-03-12 -4.7%,止损躲开"
                "更深的坑)。结论:恐慌急跌日触发 → 看榜单结构定攻防(权益霸榜"
                "买权益冠军,债基霸榜买固收冠军)→ 大盘回撤 5% 离场。")
