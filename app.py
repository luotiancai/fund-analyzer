...
with tab_sse:
    ...
    if sse_df is None or sse_df.empty:
        ...
        with st.expander("📜 策略复盘:买入近3月冠军,大盘回撤超5%卖出"):
            ...
            st.caption(
                "案例一买在银行/价值动量顶点,随后风格切换到创业板成长,大盘没跌"
                "冠军却亏 4.4%;案例三买在券商涨停潮当天,动量已透支,牛市里"
                "反而跑输大盘 5 个点——追冠军的经典死法。案例二熊市里冠军全是"
                "债基,趋势延续小赚。2018 两次重建榜单的原始前几名均为巨额赎回"
                "假净值(单日 +8%~+19% 的\"纯债\"),已剔除;2019 榜首为券商"
                "指数基金群体一致上涨,真实。")
