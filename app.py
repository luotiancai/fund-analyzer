    ...
    if au_df is None or au_df.empty:
        ...
        with st.expander("📜 黄金策略复盘:高点回撤15%卖出"):
            st.dataframe(pd.DataFrame({
                ...
                "卖出日": ["2020-11-25", "2026-02-02"],
                "卖出价(元/克)": ["378.45", "1030.00"],
                "持有收益": ["+20.8%", "+156.5%"],
                "持有天数": ["520", "1428"],
                ...
                "点评": [
                    ...
                    "人民币口径靠汇率缓冲仅回撤 ~9%,15% 线未被扫,完整拿住"
                    " 2023-2025 超级牛市;2026-01-29 见顶 +209.6% 后两个交易日"
                    "暴跌 17% 触发线,02-02 离场落袋 +156.5%;离场后金价又跌"
                    " 15%(至 2026-07 的 872),真顶部再次一击必中"],
            }), use_container_width=True, hide_index=True)
            st.caption(
