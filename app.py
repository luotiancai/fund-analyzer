        ...
        with st.expander("📜 策略复盘:买入近3月冠军,大盘回撤超5%卖出"):
            st.dataframe(pd.DataFrame({
                ...
                "当时近3月冠军(C类,剔除债基/QDII/赎回假象)": [
                    ...
                    "前海开源中国稀缺资产C (002079)",
                    "招商中证煤炭等权指数C (013596)"],
                "冠军近3月涨幅": ["+8.88%", "+3.42%", "+37.12%", "+35.57%",
                                "+34.36%", "+26.76%", "+44.60%", "+13.05%"],
                "卖出日(回撤>5%)": ["2018-03-23", "2018-11-29", "2019-04-26",
                                  "2020-02-28", "2020-03-18", "2020-07-16",
                                  "2020-09-09", "2022-07-15"],
                "持有收益": ["-4.51%", "-2.48%", "-1.21%", "+22.11%",
                            "-4.69%", "+32.52%", "-2.68%", "+10.34%"],
                "同期上证": ["+0.7%", "+1.0%", "+4.2%", "+4.8%",
                            "-6.6%", "+17.6%", "+1.4%", "+10.2%"],
            }), use_container_width=True, hide_index=True)
            st.caption(
                "口径:只买 C 类(实盘习惯),剔除债基、类固收混合(中位日波动"
                "<0.3% 视为没有真实股票仓)、QDII/海外资产、巨额赎回假净值"
                "(2018 两次榜单前几名全是单日 +8%~19% 的假\"纯债\")。"
                "赚钱的三次共性=买入日有恐慌性急跌:2020-02-03 大盘 -7.7%"
                "(19 日 +22%,峰值 +34%)、2020-03-18 熔断尾声(120 天 +32.5%,"
                "峰值 +51.6%)、2022-04-25 大盘 -5.1% 买国内煤炭 C(81 天 +10.3%,"
                "峰值 +27.6%;原始榜首原油 QDII 与 A 股反弹脱钩仅 +1.3%,故限定"
                "国内资产)。亏钱的五次=买在亢奋、下跌中段或熊市无动量:"
                "2019-02-25 券商涨停潮追入 -1.2%、2018-10-29 熊市里最抗跌的银行"
                "指数也只是缓跌 -2.5%、2020-07-16 C 类冠军稀缺资产垂直拉升后追入"
                " -2.7%(当年鹏华酒A无C份额;A冠军白酒当日急跌 -8.9% 反而 +7.1%,"
                "佐证恐慌折价的价值)、2018-02-09 风格切换 -4.5%、2020-03-12 熔断"
                "中段 4 日止损 -4.7%(止损躲开了更深的坑)。结论:追冠军的成败="
                "买入时点恐慌程度 × 冠军动量存续 × 冠军是否国内资产。")
