        ...
        with st.expander("📜 策略复盘:买入近3月冠军,大盘回撤超5%卖出"):
            st.dataframe(pd.DataFrame({
                ...
                "当时近3月冠军(剔除赎回假象)": [
                    ...
                    "万家经济新动能C (005312)",
                    "万家经济新动能C (005312)"],
                "冠军近3月涨幅": ["+8.95%", "+5.20%", "+38.70%",
                                "+35.57%", "+34.36%"],
                "卖出日(回撤>5%)": ["2018-03-23", "2018-11-29",
                                  "2019-04-26", "2020-02-28", "2020-03-18"],
                "持有收益": ["-4.38%", "+1.25%", "-1.14%", "+22.11%", "-4.69%"],
                "同期上证": ["+0.7%", "+1.0%", "+4.2%", "+4.8%", "-6.6%"],
            ...
            st.caption(
                ...
                "日 +22%(峰值 +34%)。案例五同一只冠军,买在全球熔断的下跌"
                "中段而非恐慌尽头,4 个交易日即触发止损 -4.7%(但止损救了它:"
                "3/23 才是底,躲掉了后面一段)。结论:追冠军的成败=买入时点的"
                "恐慌程度 × 冠军风格的剩余动量;垂直拉升后追入必败,恐慌坑底"
                "追入尚有动量的冠军才有超额,下跌中段连恐慌买点都不成立时,"
                "5% 止损线是唯一的保护。2018 两次榜单原始前几名均为巨额赎回"
                "假净值(单日 +8%~+19% 的\"纯债\"),已剔除;2019/2020 榜首真实。")
