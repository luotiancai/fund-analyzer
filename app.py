...
with tab_sse:
    ...
    if sse_df is None or sse_df.empty:
        ...
        with st.expander("📜 策略复盘:买入近3月冠军,大盘回撤超5%卖出"):
            ...
            st.caption(
                "口径:只买 C 类(实盘习惯),剔除债基、QDII/海外资产、巨额赎回"
                "假净值(2018 两次榜单前几名全是单日 +8%~19% 的假\"纯债\";"
                "2018-10-29 权益类前三也是假象,干净冠军已是类固收混合)。"
                ...
                "国内资产)。亏钱的四次=买在亢奋或下跌中段:2019-02-25 券商涨停"
                "潮追入 -1.2%、2020-07-16 C 类冠军稀缺资产垂直拉升后追入 -2.7%"
                "(当年鹏华酒A无C份额;A冠军白酒当日急跌 -8.9% 反而 +7.1%,"
