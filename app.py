        ...
        with st.expander("📜 策略复盘:买入近3月冠军,大盘回撤超5%卖出"):
            st.dataframe(pd.DataFrame({
                "买入日": ["2019-02-25", "2019-05-06",
                          ...
                          "2020-07-16", "2022-04-25", "2024-02-02", "2024-09-30",
                ...
                "类型": ["混合型-灵活", "混合型-灵活", "混合型-偏股", "股票型",
                        ...
                        "混合型-偏股(煤炭价值)", "指数型-股票(券商)", "指数型-股票(北证50)",
                        "混合型-偏股(机器人)", "混合型-偏股"],
                "冠军近3月涨幅(前日口径)": [
                    "+27.48%", "+49.28%", "+45.41%",
                    "+38.48%", "+25.72%", "+56.07%", "+21.37%", "+13.61%",
                    "+30.13%", "+61.40%", "+63.60%", "+47.23%"],
                ...
                "点评": [
                    ...
                    "亢奋日买入,吃到 10/8 最后一冲后止损快跑,运气钱不可复制",
