        ...
        with st.expander("📜 策略复盘:买入近3月冠军,大盘回撤超5%卖出"):
            st.dataframe(pd.DataFrame({
                "买入日": ["2018-02-09", "2018-10-29", "2019-02-25",
                          ...
                          "2020-07-16", "2022-04-25", "2024-09-30",
                ...
                "冠军(C类全市场,按前一交易日榜单)": [
                    ...
                    "鹏华碳中和主题混合C (016531)",
                    "广发远见智选混合C (016874)"],
                "类型": ["指数型-股票(银行)", "指数型-股票(银行)",
                        "混合型-灵活", "混合型-偏股", "股票型",
                        "混合型-偏股", "股票型", "指数型-股票(煤炭)",
                        "指数型-股票(券商)", "指数型-股票(北证50)",
                        "混合型-偏股(机器人)", "混合型-偏股"],
                "冠军近3月涨幅(前日口径)": [
                    "+10.00%", "+5.36%", "+27.48%", "+45.41%",
                    "+38.48%", "+25.72%", "+56.07%", "+21.37%",
                    "+30.13%", "+61.40%", "+63.60%", "+47.23%"],
                "卖出日(回撤>5%)": ["2018-03-23", "2018-11-29", "2019-04-26",
                                  "2020-02-28", "2020-03-18", "2020-07-16",
                                  "2020-09-09", "2022-07-15", "2024-10-09",
                                  "2024-11-22", "2025-12-16", "2026-06-05"],
                "持有收益": ["-4.03%", "-2.48%", "+10.69%", "+22.11%",
                            "-12.05%", "+32.52%", "-3.17%", "+10.34%",
                            "+3.82%", "+33.24%", "+31.09%", "+39.08%"],
                "费后收益": ["-4.03%", "-2.48%", "+10.69%", "+21.50%",
                            "-13.37%", "+32.52%", "-3.17%", "+10.34%",
                            "+3.30%", "+33.24%", "+31.09%", "+39.08%"],
                "期间最高": ["+3.1%", "+3.0%", "+18.1%", "+34.2%",
                            "+0.0%", "+51.6%", "+10.5%", "+27.6%",
                            "+7.9%", "+43.9%", "+62.5%", "+50.6%"],
                "期间最大回撤": ["6.9%", "5.5%", "6.3%", "9.0%",
                              "12.1%", "12.6%", "12.4%", "13.5%",
                              "3.8%", "12.2%", "21.4%", "12.6%"],
                "同期上证": ["+0.7%", "+1.0%", "+4.2%", "+4.8%",
                            "-6.6%", "+17.6%", "+1.4%", "+10.2%", "-2.3%",
                            "+0.2%", "+23.5%", "+5.6%"],
                "点评": [
                    "恐慌坑底但银行动量已到强弩之末,随后风格切向成长,大盘没跌"
                    "冠军先亏",
                    "熊市:全榜被债基固收霸榜(防守信号),权益冠军银行指数只是"
                    "'跌得最慢',缓跌离场",
            ...
            st.caption(
                ...
                "(1+r)×(1-费率)-1);受影响的仅 2020-02-03(25天)、2020-03-12"
                "(6天)、2024-09-30(9天)三笔。三步规则:恐慌急跌日触发"
                "(QVIX>30 且当日下跌,或 -5% 级暴跌)→ 看榜单结构定攻防(权益"
                "霸榜买权益冠军,债基霸榜买固收冠军)→ 大盘从买入后高点回撤 5%"
                " 离场。")
