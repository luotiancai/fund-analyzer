...
# ── 标准策略回测参考快照(2026-07-31, 数据/规则变了要重跑, 别当成结论)──
...
# 2022-04-25 诺安创新驱动混合C(002051)         混合型-灵活  1.73 26.35  9.12 5.27  -37.80%  2022-07-15 +14.19%   0.0 +23.2%  7.3% +10.2% 大盘5.3%>=5.3%
...
# 2024-09-26 华富健康文娱灵活配置混合C(019200)  混合型-灵活  1.93 20.29  7.83 4.06  -22.41%  2024-10-09 +18.05%(费后+17.55%) 0.5 +32.8% 11.1% +8.6% 基金11.1%>=7.8%+大盘6.6%>=4.1%(同日双触发)
# 2024-10-10 海富通科技创新混合C(009024)       混合型-偏股  1.81 20.47  7.41 4.09   -2.42%  2024-11-14 +6.66%    0.0 +15.9%  8.0% +2.4%  基金8.0%>=7.4%
# 2025-04-07 财通成长优选混合C(021528)         混合型-灵活  3.41 21.30 14.53 4.26  -22.35%  2025-11-14 +140.47%  0.0 +181.4% 14.5% +28.9% 基金14.5%>=14.5%
# 2026-03-23 广发医药创新混合发起式C(017963)   混合型-偏股  2.68 22.51 12.06 4.50  -19.69%  2026-06-03 +0.44%    0.0 +14.2% 12.1%  +7.1% 基金12.1%>=12.1%
