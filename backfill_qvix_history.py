...
延迟到次日上午,而且2026-03-23(上证单日-3.63%)发布的收盘值42.16
根本不是30天期口径——那天3月合约只剩2天到期,自算它是41.31、跟42.16
基本重合,而真正30天位置上的4月合约是22.95(详见 qvix_calc 模块
docstring)。干脆自己按标准方法论把历史重算一遍,不再依赖 optbbs。
